...
public class LocationPickerActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Gson gson = new Gson();
        LoginModel loginModel = gson.fromJson(getOfflineData(RescribeConstants.TASK_LOGIN), LoginModel.class);

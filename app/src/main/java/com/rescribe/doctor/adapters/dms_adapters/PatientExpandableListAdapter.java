...
public class PatientExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(final int groupPosition, final int childPosition,
        ...
        if (opd.equalsIgnoreCase(childElement.getFileType())) {
            ...
            String s = CommonMethods.formatDateTime(childElement.getAdmissionDate(), RescribeConstants.DATE_PATTERN.DD_MM_YYYY_SLASH, RescribeConstants.DATE_PATTERN.DD_MM_YYYY_hh_mm, RescribeConstants.DATE);
            ...
            String date = CommonMethods.formatDateTime(childElement.getAdmissionDate(), RescribeConstants.DATE_PATTERN.DD_MM_YYYY_SLASH, RescribeConstants.DATE_PATTERN.DD_MM_YYYY_hh_mm, RescribeConstants.DATE);
            childViewHolder.ipdAdmissionDateValue.setText(date);

            date = CommonMethods.formatDateTime(childElement.getDischargeDate(), RescribeConstants.DATE_PATTERN.DD_MM_YYYY_SLASH, RescribeConstants.DATE_PATTERN.DD_MM_YYYY_hh_mm, RescribeConstants.DATE);

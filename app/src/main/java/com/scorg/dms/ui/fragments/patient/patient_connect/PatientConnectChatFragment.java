...
import com.scorg.dms.adapters.patient_connect.PatientConnectAdapter;
import com.scorg.dms.adapters.patient_connect.SearchedMessagesAdapter;
...
import static com.scorg.dms.util.DMSConstants.USER_STATUS.OFFLINE;
...
//                    cursor.getInt(cursor.getColumnIndex(AppDBHelper.CHAT_MESSAGES.READ_STATUS));
    ...
    public void onSuccess(String mOldDataTag, CustomResponse customResponse) {
        if (mOldDataTag.equalsIgnoreCase(DMSConstants.GET_PATIENT_CHAT_LIST)) {
    ...
    public void notifyCount(MQTTMessage message) {
        ...
        if (mReceivedPatientDataList != null && mPatientConnectAdapter != null) {
            ...
            if (!isThere) {
                ...
                patientData.setOnlineStatus(DMSConstants.USER_STATUS.ONLINE);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.leftFab:
                ...
                intent.putExtra(DMSConstants.ACTIVITY_LAUNCHED_FROM, DMSConstants.PATIENT_CONNECT);

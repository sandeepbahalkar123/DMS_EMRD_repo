...
public class TemplateListActivity extends AppCompatActivity implements TemplateAdapter.OnCardViewClickListener {
    ...
    private void initialize() {
        ...
        if (intent.getExtras() != null) {
            appointmentList = intent.getParcelableArrayListExtra(DMSConstants.APPOINTMENT_LIST);
            templateLists = intent.getParcelableArrayListExtra(DMSConstants.TEMPLATE_LIST);
        }
    ...
    public void onCardViewClick(TemplateList templateList) {
        ...
        for (AppointmentList appointmentList : appointmentList) {
            ...
            listForSms.setDocId(Integer.valueOf(DMSPreferencesManager.getString(DMSPreferencesManager.DMS_PREFERENCES_KEY.DOC_ID, mContext)));

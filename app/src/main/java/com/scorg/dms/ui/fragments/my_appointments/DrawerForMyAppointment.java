...
import com.scorg.dms.adapters.drawer_adapters.DrawerAppointmentSelectStatusAdapter;
import com.scorg.dms.adapters.drawer_adapters.DrawerAppointmetClinicNameAdapter;
...
public class DrawerForMyAppointment extends Fragment implements HelperResponse, SortByPriceFilterAdapter.onSortByAmountMenuClicked, DrawerAppointmentSelectStatusAdapter.OnClickOfFilterComponents, DrawerAppointmetClinicNameAdapter.OnClickOfFilterClinic {
    ...
    private void initialize() {
        ...
        MyAppointmentsDataModel mMyAppointmentsDataModel = getArguments().getParcelable(DMSConstants.APPOINTMENT_DATA);

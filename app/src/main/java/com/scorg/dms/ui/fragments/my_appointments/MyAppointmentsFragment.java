...
import com.scorg.dms.adapters.my_appointments.AppointmentAdapter;
...
import com.scorg.dms.ui.activities.book_appointment.SelectSlotToBookAppointmentBaseActivity;
import com.scorg.dms.ui.activities.my_appointments.MyAppointmentsActivity;
import com.scorg.dms.ui.activities.my_patients.SendSmsActivity;
import com.scorg.dms.ui.activities.my_patients.ShowMyPatientsListActivity;
import com.scorg.dms.ui.activities.my_patients.TemplateListActivity;
...
import static com.scorg.dms.ui.activities.my_patients.SendSmsActivity.RESULT_SMS_SEND;
...
public class MyAppointmentsFragment extends Fragment implements AppointmentAdapter.OnDownArrowClicked, BottomMenuAppointmentAdapter.OnMenuBottomItemClickListener, HelperResponse {
    ...
    public void onClickOfPatientDetails(PatientList patientListObject, int clinicId, String patientDetails) {
        ...
        b.putString(DMSConstants.PATIENT_INFO, patientDetails);
        b.putInt(DMSConstants.CLINIC_ID, clinicId);
        b.putInt(DMSConstants.APPOINTMENT_ID, patientListObject.getAptId());
    ...
    public void onAppointmentClicked(Integer aptId, Integer patientId, int status, String type, int childPosition, int groupPosition) {
        if (mUserSelectedDate.equals(CommonMethods.getCurrentDate(DMSConstants.DATE_PATTERN.d_M_YYYY))) {
    ...
    public void onAppointmentReshedule(PatientList patientList, String text, String cityName, String areaName) {
        ...
        com.scorg.dms.model.patient.doctor_patients.PatientList patientListforBookAppointment = new com.scorg.dms.model.patient.doctor_patients.PatientList();
        ...
        intent.putExtra(DMSConstants.PATIENT_INFO, patientListforBookAppointment);
        intent.putExtra(DMSConstants.PATIENT_DETAILS, text);
        intent.putExtra(DMSConstants.IS_APPOINTMENT_TYPE_RESHEDULE, true);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.leftFabForAppointment:
                ...
                intent.putExtra(DMSConstants.ACTIVITY_LAUNCHED_FROM, DMSConstants.MY_APPOINTMENTS);
                startActivityForResult(intent, Activity.RESULT_OK);
                break;
        }
    }
        ...
        if (mOldDataTag.equalsIgnoreCase(DMSConstants.TASK_GET_DOCTOR_SMS_TEMPLATE)) {
            ...
            if (templateBaseModel.getTemplateDataModel() != null) {
                ...
                if (!templateLists.isEmpty()) {
                    ...
                    intent.putParcelableArrayListExtra(DMSConstants.APPOINTMENT_LIST, mAppointmentLists);
                    ...
                    for (AppointmentList appointmentList : mAppointmentLists) {
                        ...
                        listForSms.setDocId(Integer.valueOf(DMSPreferencesManager.getString(DMSPreferencesManager.DMS_PREFERENCES_KEY.DOC_ID, getContext())));
                    ...
                    intent.putExtra(DMSConstants.SMS_DETAIL_LIST, clinicListForSms);
                    intent.putExtra(DMSConstants.SMS_PATIENT_LIST_TO_SHOW, patientListsToShowOnSmsScreen);
                ...
                for (AppointmentList appointmentList : mAppointmentLists) {
                    ...
                    listForSms.setClinicId(appointmentList.getClinicId());
                    listForSms.setClinicName(appointmentList.getClinicName());
                    listForSms.setDocId(Integer.valueOf(DMSPreferencesManager.getString(DMSPreferencesManager.DMS_PREFERENCES_KEY.DOC_ID, getActivity())));
                    listForSms.setLocationId(appointmentList.getLocationId());
                    listForSms.setTemplateContent("");
                    for (PatientList patientList : appointmentList.getPatientList()) {
                        PatientInfoList patientInfoList = new PatientInfoList();

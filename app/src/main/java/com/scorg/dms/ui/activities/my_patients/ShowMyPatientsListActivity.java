...
import com.scorg.dms.ui.fragments.patient.patient_connect.ChatPatientListFragment;
...
public class ShowMyPatientsListActivity extends AppCompatActivity implements DrawerForMyPatients.OnDrawerInteractionListener {
    ...
    private void initialize() {
        ...
        if (mIntent.getExtras() != null) {
            mActivityCalledFrom = mIntent.getStringExtra(DMSConstants.ACTIVITY_LAUNCHED_FROM);
        }

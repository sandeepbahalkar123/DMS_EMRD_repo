package com.scorg.dms.ui.fragments.new_patient;
...
import com.scorg.dms.adapters.new_patient.NewPatientAdapter;
...
import com.scorg.dms.model.new_patient.NewPatientsDetail;
...
public class NewPatientFragment extends Fragment implements NewPatientAdapter.OnDownArrowClicked, BottomMenuForCompleteAppointmentAdapter.OnMenuBottomItemClickListener, HelperResponse {
    ...
    private void init() {
        ...
        NewPatientBaseModel mNewPatientBaseModel = getArguments().getParcelable(DMSConstants.MY_PATIENTS_DATA);

package com.scorg.dms.ui.fragments.patient.patient_connect;
...
import com.scorg.dms.adapters.patient_connect.ChatPatientListAdapter;
...
public class ChatPatientListFragment extends Fragment implements ChatPatientListAdapter.OnDownArrowClicked, HelperResponse {
    ...
    private void init() {
        ...
        mFromWhichActivity = getArguments().getString(DMSConstants.ACTIVITY_LAUNCHED_FROM);
        ...
        mMyPatientsAdapter = new ChatPatientListAdapter(getActivity(), patientLists, this, mFromWhichActivity.equals(DMSConstants.MY_APPOINTMENTS));
    ...
    public void onClickOfPatientDetails(PatientList patientListObject, String text) {
        if (mFromWhichActivity.equals(DMSConstants.MY_APPOINTMENTS)) {
            Intent intent = new Intent(getActivity(), SelectSlotToBookAppointmentBaseActivity.class);
            intent.putExtra(DMSConstants.PATIENT_INFO, patientListObject);
            intent.putExtra(DMSConstants.PATIENT_DETAILS, text);
            intent.putExtra(DMSConstants.IS_APPOINTMENT_TYPE_RESHEDULE, false);
            ...
            intent.putExtra(DMSConstants.CLINIC_ID, patientListObject.getClinicId());
            intent.putExtra(DMSConstants.PATIENT_HOS_PAT_ID, patientListObject.getHospitalPatId());
            intent.putExtra(DMSConstants.IS_CALL_FROM_MY_PATIENTS, true);
            intent.setFlags(Intent.FLAG_ACTIVITY_FORWARD_RESULT);

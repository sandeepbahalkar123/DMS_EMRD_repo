...
import com.scorg.dms.services.ChatBackUpService;
...
import com.scorg.dms.ui.fragments.patient.patient_connect.PatientConnectChatFragment;
...
import static com.scorg.dms.preference.DMSPreferencesManager.DMS_PREFERENCES_KEY.BACK_UP;
import static com.scorg.dms.services.ChatBackUpService.CHAT_BACKUP;
import static com.scorg.dms.services.ChatBackUpService.RUNNING;
...
public class PatientConnectActivity extends AppCompatActivity implements HelperResponse {
    ...
    private void initialize() {
        ...
        if (RUNNING)
            ...
            boolean isBackupTaken = DMSPreferencesManager.getBoolean(BACK_UP, this);
            ...
            if (!isBackupTaken) {
                ...
                button_skip.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        DMSPreferencesManager.putBoolean(BACK_UP, true, PatientConnectActivity.this);
                        dialog.dismiss();
                        addFragment();
                    }
                });
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (Activity.RESULT_OK == resultCode) {
            if (requestCode == PATIENT_CONNECT_REQUEST) {
                PatientData patientData = data.getParcelableExtra(DMSConstants.CHAT_USERS);

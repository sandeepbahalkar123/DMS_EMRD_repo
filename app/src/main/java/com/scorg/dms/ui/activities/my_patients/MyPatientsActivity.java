package com.scorg.dms.ui.activities.my_patients;
...
import com.scorg.dms.services.LoadAllPatientsService;
import com.scorg.dms.services.SyncOfflinePatients;
import com.scorg.dms.ui.customesViews.CustomTextView;
import com.scorg.dms.ui.fragments.patient.my_patient.DrawerForMyPatients;
import com.scorg.dms.ui.fragments.patient.my_patient.MyPatientsFragment;
...
import static com.scorg.dms.services.LoadAllPatientsService.LOAD_ALL_PATIENTS;
import static com.scorg.dms.services.LoadAllPatientsService.STATUS;
...
public class MyPatientsActivity extends AppCompatActivity implements DrawerForMyPatients.OnDrawerInteractionListener {
    ...
    private void initialize() {
        ...
        if (mIntent.getExtras() != null) {
            String mActivityCalledFrom = mIntent.getStringExtra(DMSConstants.ACTIVITY_LAUNCHED_FROM);
            bundle.putString(DMSConstants.ACTIVITY_LAUNCHED_FROM, mActivityCalledFrom);
        }
        ...
        boolean isPatientDownloaded = DMSPreferencesManager.getBoolean(DMSPreferencesManager.DMS_PREFERENCES_KEY.PATIENT_DOWNLOAD, this);
        ...
        if (NetworkUtil.getConnectivityStatusBoolean(mContext)) {
            if (isPatientDownloaded) {
                ...
                startIntentUpload.setAction(DMSConstants.STARTFOREGROUND_ACTION);
    ...
    public void onApply(RequestSearchPatients mRequestSearchPatients, boolean isReset) {
        mRequestSearchPatients.setDocId(Integer.valueOf(DMSPreferencesManager.getString(DMSPreferencesManager.DMS_PREFERENCES_KEY.DOC_ID, mContext)));

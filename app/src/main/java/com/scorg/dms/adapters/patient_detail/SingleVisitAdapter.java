...
import static com.scorg.dms.util.CommonMethods.stripExtension;
            ...
            item.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (fileExtension.contains(".doc") || fileExtension.contains(".odt") || fileExtension.contains(".ppt") || fileExtension.contains(".odp") || fileExtension.contains(".xls") || fileExtension.contains(".ods") || fileExtension.contains(".pdf")) {
                        ...
                        intent.putExtra(DMSConstants.DOCUMENTS, tag);
                        intent.putExtra(DMSConstants.IS_URL, true);
                        intent.putParcelableArrayListExtra(DMSConstants.ATTACHMENTS_LIST, new ArrayList<VisitCommonData>(mListDataHeaderAllAttachmentCommonDataList));
                        mContext.startActivity(intent);
                    }
                }
            });

...
import static com.scorg.dms.adapters.waiting_list.DraggableSwipeableViewAllWaitingListAdapter.CONFIRMED;
...
public class DraggableSwipeableActiveWaitingListAdapter
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        if (!item.getActiveAll().getWaitingInTime().equals("")) {
            ...
            String waitingTime = CommonMethods.formatDateTime(item.getActiveAll().getWaitingInTime(), DMSConstants.DATE_PATTERN.hh_mm_a, DMSConstants.DATE_PATTERN.HH_mm_ss, DMSConstants.TIME).toLowerCase();
        ...
        if (!item.getActiveAll().getAppointmentTime().equals("")) {
            ...
            String appointmentScheduleTime = CommonMethods.formatDateTime(item.getActiveAll().getAppointmentTime(), DMSConstants.DATE_PATTERN.hh_mm_a, DMSConstants.DATE_PATTERN.HH_mm_ss, DMSConstants.TIME).toLowerCase();

...
public class PatientConnectAdapter extends RecyclerView.Adapter<PatientConnectAdapter.ListViewHolder> implements Filterable {
    ...
    public void onBindViewHolder(final ListViewHolder holder, int position) {
        ...
        if (doctorConnectChatModel.getLastChatTime() != null) {
            String timeT = CommonMethods.getDayFromDateTime(doctorConnectChatModel.getLastChatTime(), DMSConstants.DATE_PATTERN.UTC_PATTERN, DMSConstants.DATE_PATTERN.DD_MM_YYYY_SLASH, DMSConstants.DATE_PATTERN.hh_mm_a);

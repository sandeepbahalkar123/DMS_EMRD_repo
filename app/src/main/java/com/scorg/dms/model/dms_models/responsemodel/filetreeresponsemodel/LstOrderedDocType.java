...
public class LstOrderedDocType implements Parcelable {

    public final static Parcelable.Creator<LstOrderedDocType> CREATOR = new Creator<LstOrderedDocType>() {


        @SuppressWarnings({
                "unchecked"
        })
        public LstOrderedDocType createFromParcel(Parcel in) {
            return new LstOrderedDocType(in);
        }

        public LstOrderedDocType[] newArray(int size) {
            return (new LstOrderedDocType[size]);
        }
    ...
    protected LstOrderedDocType(Parcel in) {

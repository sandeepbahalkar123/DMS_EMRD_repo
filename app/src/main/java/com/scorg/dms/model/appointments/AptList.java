...
public class AptList implements CustomResponse, Serializable {
    ...
    public String getAptDate() {
        if (aptDate.contains("T")) {
            ...
            aptDate = CommonMethods.formatDateTime(dateBeforeTime + "T" + aptTime + ".000Z", DMSConstants.DATE_PATTERN.YYYY_MM_DD_hh_mm_a, DMSConstants.DATE_PATTERN.UTC_PATTERN, DMSConstants.DATE);
        }
        return aptDate;
    }
}
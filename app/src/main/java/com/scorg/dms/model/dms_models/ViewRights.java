...
public class ViewRights implements Serializable {
    ...
    @SerializedName("IsViewAppointmentPatient")
    @Expose
    private boolean isViewAppointmentPatient;
    ...
    public boolean isViewAppointmentPatient() {
        return isViewAppointmentPatient;
    }

    public void setViewAppointmentPatient(boolean viewAppointmentPatient) {
        isViewAppointmentPatient = viewAppointmentPatient;
    }
}